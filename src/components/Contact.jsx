...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: MapPin,
      title: "Address",
      value: "GM Infinite Silver Corner, Atmananda Colony, RT Nagar, Bangalore -32",
    ...
    >
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          >
            Ready to transform your vision into reality? Let's discuss how we can bring 
          ...
          >
            {[
              ...
              { icon: Shield, text: "Secure & Trusted", color: "text-green-500" },
          ...
          >
            ...
            <div className="space-y-4">
              ...
              {contactInfo.map((info, index) => (
                ...
                >
                  {/* Background glow */}
                  <div className={`absolute inset-0 ${info.bgGlow} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                  
                  <div className={`w-12 h-12 bg-gradient-to-br ${info.gradient} rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 relative z-10 shadow-lg`}>
                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-slate-600 leading-relaxed">
                      ...
                      get back to you within 24 hours with a comprehensive response.
                    </p>
                  </motion.div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      >
                        ...
                        <input
                          ...
                          required
                          className="w-full px-5 py-4 bg-white/50 backdrop-blur-sm border-2 border-slate-200/50 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 text-slate-900 placeholder-slate-400"
                    ...
                    >
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-5 py-4 bg-white/50 backdrop-blur-sm border-2 border-slate-200/50 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 text-slate-900"
                      >
                    ...
                    >
                      ...
                      <textarea
                        ...
                        required
                        rows={6}
                        className="w-full px-5 py-4 bg-white/50 backdrop-blur-sm border-2 border-slate-200/50 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 resize-none text-slate-900 placeholder-slate-400"
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-800 text-white font-bold py-5 px-8 rounded-xl shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 group relative overflow-hidden"
                    >
        ...
        >
          <div className="relative bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 rounded-2xl p-6 lg:p-10 text-white overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              >
                Let's schedule a consultation to discuss your project requirements and 
                discover how our innovative solutions can accelerate your business growth 
              ...
              >
                <motion.button
                  ...
                  onClick={() => window.open('https://calendly.com/insight-technosoft', '_blank')}
                >
              ...
              >
                📞 Available Mon-Fri 9AM-6PM IST | 🚀 Free consultation | ⚡ Same-day response
              </motion.div>
            </div>
          </div>
        </motion.div>
